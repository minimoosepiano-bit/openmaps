...
- **Conquest trail** – the land taken by the newest territory change is drawn in a lighter
  shade of the conquering nation's colour; each further change steps it one notch closer to
  the full colour, so an advancing front trails a fading comet tail behind it.
